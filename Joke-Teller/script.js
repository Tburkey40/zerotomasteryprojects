...
function tellMe(joke) {
    ...
    VoiceRSS.speech({
        key: 'afcf957c31894b07930a3d9fb18d5318',
        src: joke,
        hl: 'en-us',
        r: 0,
        c: 'mp3',
...
async function getJokes() {
    let joke = '';
    const apiURL = 'https://v2.jokeapi.dev/joke/Programming,Dark,Pun?blacklistFlags=nsfw,religious,political,racist,sexist,explicit';
    try {
